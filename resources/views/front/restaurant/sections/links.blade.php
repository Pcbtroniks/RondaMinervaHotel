<section>
    ...
    <div class="px-4 flex flex-col items-center pb-16">
        ...
        <a target="_blank" href="https://rondaminervahotel.com/files/restaurant-menu.pdf" class="bg-white flex items-center my-5 py-4 px-2 sm:px-4 rounded-full shadow-card-hard sm:w-[29.25rem] w-[20.5rem]">
            <div class="w-[4.5rem]">
