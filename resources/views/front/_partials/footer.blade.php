<footer>
    ...
    <div class="relative bg-ronda-dark py-20 flex md:flex-row md:px-6 sm:justify-center flex-col items-center gap-24">

        <div>
            <img class="w-64" src="{{ asset('img/logos/logo-white.png') }}" alt="Hotel Ronda Minerva Todo gira en torno a ti">
        </div>
        ...
        <div class="sm:w-[335px] text-white px-3">
        ...
        <img class="absolute sm:top-0 top-2/3 right-0 -scale-x-100" src="{{ asset('assets/icons/lineas-cruvas.svg') }}" alt="">
